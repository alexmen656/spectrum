...
def get_all_files(root_dir):
    ...
    return sorted(file_paths, key=lambda x: x[0])
...
def update_readme(new_section):
    ...
    # Entfernt alten Block zwischen ### Documents and Files und der nächsten ### Überschrift oder EOF
    updated_content = re.sub(
        r"### Documents and Files\n(?:- .*\n)*",  # alte Linkliste entfernen
        f"{new_section}\n",
        readme_content,
        flags=re.MULTILINE
    )
...
if __name__ == "__main__":
    ...
    commit_and_push()
    print("✅ README.md wurde ersetzt und gepusht.")
